...
server <- function(input, output) {
  ...
  caption = "Source: State of California, Department of Finance. Demographic Research Unit. State and County Population Projections 2020-2060 [computer file]. Sacramento, California. July 2023"
  ...
  plot_input <- function() {
      ...
      scale_color_manual(
        ...
        name = "Section of the population: "
        ) +
      ...
      theme(
        ...
        plot.title = ggtext::element_textbox_simple(
          face = "bold", size = 18, margin = margin(b = 15)
          ),
        plot.subtitle = ggtext::element_textbox_simple(
          color="#444444", margin = margin(b = 15)
          ),
        plot.caption = ggtext::element_textbox_simple(
          color = "#444444", margin = margin(t = 15)),
        ) +
